...
public class NotepadEditor extends JFrame{
    ...
    private void textChecker(String content){
        content=content.toLowerCase();
         ...
         kuralina uymaayan yani tamamen yanlış kelimeleri tutmak için bir list.*/
        ...
        for (int i = 0; i < splitContent.length; i++) {
            ...
            /* metnin icindeki kelimelerin wordlistte olup olmadığını kontrol eden
            değiskenler. */
            ...
            // ListIterator kullanilarak koleksiyon icinde gezinti sağlandı.
    ...
    private void findButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_findButtonActionPerformed
        // Edittext'in olduğu yerlerin bos birakilmaması kontrolu
    ...
    private void textAreaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textAreaKeyTyped
        /* TextArea'ya herhangi bir yazım oldugunda metnin goruntusunun karismaması
